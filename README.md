...
This build keeps the working v2.9 Firebase/Host/TV foundation and expands only the
content-selection and visual-display layer.

## Production banks

- Next Gen pool: 137
- Old School pool: 167
- Family Showdown pool: 40 (10 x 1-point, 10 x 2-point, 10 x 3-point, 10 x 4-point)
- Bonus Vault: 30
- Omega: 12
- Rapid Fire logo pool: 24
- Logo Challenge: 24
- Who Am I?: 15
- What Is This?: 15
- Name That Artist: 20
- Movie / TV Challenge: 20

## Selection rules

- Next Gen: 30 unique random questions per game.
- Old School: 30 unique random questions per game.
...
## v3.2 Home / TV Hero Restore
- Visual-only patch.
- Restored approved full hero artwork (cassette, record, CD, iPod, phone) on:
  - Host Home landing screen
  - TV Connect / Instruction screen
- Left the compact logo in place for in-game scoreboards and headers.
- No Firebase, sync, gameplay, or question-bank changes.
